...
// -----------------------------------------------
 ...
 echo "<img id='cryptogram' src='" . ROOT_PATH . "core/tools/cryptographp/cryptographp.php?cfg=".$cfg."&".SID."' />";
 if ($reload) echo "<a title='".($reload==1?'':$reload)."' id=\"cryptogram-reloader-container\" onclick=\"javascript:document.images.cryptogram.src='" . ROOT_PATH . "core/tools/cryptographp/cryptographp.php?cfg=".$cfg."&".SID."&'+Math.round(Math.random(0)*1000)+1\"><img src=\"" . ROOT_PATH . "core/tools/cryptographp/images/reload.png\" id='cryptogram-reloader'></a>";
 //echo "</tr></table>";
 }
