...
$cryptheight = 31;   // Hauteur du cryptogramme (en pixels)

$bgR  = 220;         // Couleur du fond au format RGB: Red (0->255)
$bgG  = 220;         // Couleur du fond au format RGB: Green (0->255)
$bgB  = 220;         // Couleur du fond au format RGB: Blue (0->255)
...
$charR = 100;     // Couleur des caractères au format RGB: Red (0->255)
$charG = 100;     // Couleur des caractères au format RGB: Green (0->255)
$charB = 100;     // Couleur des caractères au format RGB: Blue (0->255)
...
$brushsize = 1;        // Taille d'ecriture du princeau (en pixels) 
